...
void repair(pchrom pop, struct info d, int mat[][2]); //TIPO 3

float calcula_peso(int sol[], struct info d, int mat[][2]); //TIPO 3 E 4

void repair_sofrega(pchrom pop, struct info d, int mat[][2]); // TIPO 4
